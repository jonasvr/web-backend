    ...
    if(isset($_POST['submit']))
            {
                ...
                header("Location: opdracht-sessions2.php");
...
<html>
    ...
    <body class="web-backend-opdracht">
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>Zorg er nu voor, dat wanneer de pagina gefresht wordt door middel van <kbd>F5</kbd> / <kbd><kdb>cmd</kdb> + <kbd>r</kbd></kbd> de ingevulde informatie in de invulvelden blijft staan.</li>
        ...
        <div class="facade-minimal" data-url="opdracht-sessions.php">
                            <h1>Deel 1: registratiegegevens</h1>
