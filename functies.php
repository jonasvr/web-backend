<?php
        ...
        function optionString($txt)
        {
            $str=array();
            $str['upper']=strtoupper($txt);
            $str['length']=strlen($txt);

            return $str;
        }
$berekenSom=berekenSom(2,3);
$vermenigvuldig=vermenigvuldig(2,3);
$isEven=isEven(2);
$optionString=optionString("jippiekaheee");
...
<html>
    ...
    <body class="web-backend-opdracht">
        ...
        <h1>deel1</h1>
            <p>som: <?php echo $berekenSom;?></p>
            <p>vermenigvuldiging: <?php echo $vermenigvuldig;?></p>
            <p>even?: <?php echo $isEven;?></p>
            <pre>string: <?php print_r($optionString);?></pre>
    </body>
</html>