<?php
        ...
        $arraySplit = str_split($text);
        rsort($arraySplit);
        $reversed = array_reverse($arraySplit);
        $telling= array();

        foreach($reversed as $value)
        {
           if ( isset ( $telling[ $value ] ) )
            {
        ...
        $totaalVerschillendeChar=count($telling);
...
<html>
    ...
    <h1>deel 1</h1>
    <p>verschillende char: <?php echo $totaalVerschillendeChar;?></p>
            <pre>telling char: <?php print_r($telling);?></pre>
    </body>
</html>
