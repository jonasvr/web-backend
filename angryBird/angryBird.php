<?php
    ...
    function calculateHit()
    {
        ...
        {
            --$pigHealth;
           $boodschap[]='Raak! Er zijn nog ' . $pigHealth .' varkens over.';
        }else{
            echo 'niets';
            $boodschap[]='Mis! Nog '.$pigHealth.' varkens in het team.';
        }
    ...
    function launchAngryBird()
    {
        ...
        if ($pigHealth>0 && $maximumThrows!=0)
        {
            $shot=calculateHit();
            --$maximumThrows;
            launchAngryBird();
            ...
            if ($pigHealth>0)
            {
                $boodschap[]='Helaas, je hebt verloren.';
            }else{
                $boodschap[]='Hoera! Hoera! Hoera! Je hebt gewonnen!';            
            }
        }
    }
