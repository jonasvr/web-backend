<?php
$array1  = array("koe","giraf", "vis", "aap", "hond");
$elementen = count($array1);

$teZoekenDier="aap";

$boodschap="niet gevonden";
if(in_array ($teZoekenDier,$array1))//*return true of false
    {$boodschap="gevonden";}

//deel 2
sort($array1);
$zoogdieren=array('kat','rat','dolfijn');
$dierenLijst=array();
$dierenLijst=array_merge($array1,$zoogdieren);

//deel 3
$array3=array(8, 7, 8, 7, 3, 2, 1, 2, 4);
...
<html>
    ...
    <body class="web-backend-opdracht">
        ...
        <p>aantal elementen in array1: <?php echo $elementen; ?></p>
        <p><?php echo $boodschap; ?></p>

        <h1>oplossing deel 2</h1>
        <pre><?php print_r($array1); ?></pre>
        <pre><?php print_r($dierenLijst); ?></pre>

        <h1>oplossing deel 3</h1>
