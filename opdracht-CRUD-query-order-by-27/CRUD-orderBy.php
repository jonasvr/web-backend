<?php
    ...
    try
    {
        ...
        if ( isset( $_REQUEST['delete'] ) ) //knop ingedrukt?
        {
            ...
            if ( $delete )
            {
                $boodschap = 'Deze record is succesvol verwijderd.';
            }
            else
            {
                $boodschap = 'Deze record kon niet verwijderd worden. Reden: ' . $statement->errorInfo(2); // php.net/manual/en/pdo.errorinfo.php
            }
        }
    ...
    catch ( PDOException $e )
    {
        ...
        $boodschap=   'De connectie is niet gelukt.';
    }
    ?>
<!doctype html>
<html>
