    ...
    <body class="web-backend-opdracht">
        ...
        <section class="body">
            ...
            <ul>
                ...
                <li>Zoek op het internet naar drie verschillende artikels en bewaar de volgende dingen in een multidimensionele array:
                    <ul>
                        <li>De titel van het artikel</li>
                        <li>Minstens één paragraaf</li>
                        <li>Een afbeelding die bij het artikel hoort
                            <p>Je plaatst deze image-bestanden best in een aparte map (bv. <span class="directory-sa-folder">img</span>)</p>
                        </li>
                    </ul>

                <li>Het is de bedoeling dat we een een mini-krant maken waarbij de gebruiker kan surfen naar een overzicht van de artikels, het resultaat ziet er ongeveer als volgt uit:
                    ...
                    <div class="facade-minimal" data-url="http://www.app.local/index.php">
                        ...
                        <section class="articles">
                            ...
                            <article class="multiple">
                                ...
                                <p>Acht belangrijke technologiebedrijven, zoals Googl...</p>
                                <p class="read-more"><a href="#">Lees meer</a></p>
                            </article>

                            <article class="multiple">
                                <h1>Wilde weldoener stopt geld in brievenbussen</h1>
                                <p>9 december 2013</p>
                                <img src="http://web-backend.local/img/opdracht-get-artikel-02.jpg" alt="De residentie in Koksijde waar de weldoener aan het werk was.">
                                <p>Bewoners van twee appartements­blokken in Koksijd...</p>
                                <p class="read-more"><a href="#">Lees meer</a></p>
                            </article>

                            <article class="multiple">
                                <h1>Originele stukken Hergé geveild voor honderdduizenden euro’s</h1>
                                <p>9 december 2013</p>
                                <img src="http://web-backend.local/img/opdracht-get-artikel-03.jpg" alt="Kuifje en Bobby">
                                <p>Twee originele stukken van Hergé zijn zondag voor...</p>
                                <p class="read-more"><a href="#">Lees meer</a></p>
                            </article>
                        </div>
